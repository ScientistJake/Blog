...
Note this is part 3 of a series on clustering RNAseq data. Check out [part one  on hierarcical clustering here](http://www.2-bitbio.com/2017/04/clustering-rnaseq-data-making-heatmaps.html) and [part two on K-means clustering here](http://www.2-bitbio.com/2017/10/clustering-rnaseq-data-using-k-means.html).

```{r pressure, echo=FALSE, out.width = '100%'}
knitr::include_graphics("../../img/fresh-fuzzy-peaches.jpg")
```
...
magick::image_write(animate(p1, width = 500, height = 320), "./public/post/temp/increasing_m.gif")
```
<img src="/post/temp/increasing_m.gif"></img>
