...
author: Jake Warner
date: '2020-07-29'
slug: how-to-create-an-aws-ec2-instance
categories: []
tags:
  - Linux
---
...
## Contents: 
* [Introduction](https://2-bitbio.com/post/2020-07-29-how-to-create-an-aws-ec2-instance/index.html#introduction)  
* [Getting started](https://2-bitbio.com/post/2020-07-29-how-to-create-an-aws-ec2-instance/index.html#getting-started)  
* [Accessing an instance via ssh](https://2-bitbio.com/post/2020-07-29-how-to-create-an-aws-ec2-instance/index.html#accessing-an-instance-via-ssh) 
     - [From Mac OSX / Linux](https://2-bitbio.com/post/2020-07-29-how-to-create-an-aws-ec2-instance/index.html#accessing-an-instance-via-ssh-from-a-mac-linux) 
* [Playing around with your instance](https://2-bitbio.com/post/2020-07-29-how-to-create-an-aws-ec2-instance/index.html#playing-around-with-your-instance) 
* [Moving files on and off via scp](https://2-bitbio.com/post/2020-07-29-how-to-create-an-aws-ec2-instance/index.html#moving-files-on-and-off-via-scp) 
* [Monitoring the instance](https://2-bitbio.com/post/2020-07-29-how-to-create-an-aws-ec2-instance/index.html#monitoring-the-instance) 
* [Shutting down instances and cleaning up](https://2-bitbio.com/post/2020-07-29-how-to-create-an-aws-ec2-instance/index.html#shutting-down-an-instance-and-cleaning-up) 
* [Learn more](https://2-bitbio.com/post/2020-07-29-how-to-create-an-aws-ec2-instance/index.html#learn-more) 

<a id="introduction" class="anchor" aria-hidden="true" href="#introduction"></a>
...
<a id="getting-started" class="anchor" aria-hidden="true" href="#getting-started"></a>
...
![](https://github.com/ScientistJake/getting_started_with_AWS/blob/master/img/getting_started_1.png?raw=true)
...
![](https://github.com/ScientistJake/getting_started_with_AWS/blob/master/img/getting_started_2.png?raw=true)
...
![](https://github.com/ScientistJake/getting_started_with_AWS/blob/master/img/getting_started_3.png?raw=true)

On this step you can add additional storage. [Check this](https://aws.amazon.com/ebs/volume-types/) for storage options.  

![](https://github.com/ScientistJake/getting_started_with_AWS/blob/master/img/getting_started_4.png?raw=true)
...
![](https://github.com/ScientistJake/getting_started_with_AWS/blob/master/img/getting_started_5.png?raw=true)
...
![](https://github.com/ScientistJake/getting_started_with_AWS/blob/master/img/getting_started_6.png?raw=true)
...
![](https://github.com/ScientistJake/getting_started_with_AWS/blob/master/img/getting_started_7.png?raw=true)

<a id="accessing-an-instance-via-ssh" class="anchor" aria-hidden="true" href="#accessing-an-instance-via-ssh"></a>

## Accessing an instance via ssh  

<a id="accessing-an-instance-via-ssh-from-a-mac" class="anchor" aria-hidden="true" href="#accessing-an-instance-via-ssh-from-a-mac"></a>
...
<a id="playing-around-with-your-instance" class="anchor" aria-hidden="true" href="#playing-around-with-your-instance"></a> 
...
![](https://github.com/ScientistJake/getting_started_with_AWS/blob/master/img/htop.png?raw=true)
...
<a id="moving-files-on-and-off-via-scp" class="anchor" aria-hidden="true" href="#moving-files-on-and-off-via-scp"></a> 
...
<a id="monitoring-the-instance" class="anchor" aria-hidden="true" href="#monitoring-the-instance"></a> 

## Monitoring the instance:  
You can monitor the instance usage directly from the ec2 console under the "Monitoring" tab:  

![](https://github.com/ScientistJake/getting_started_with_AWS/blob/master/img/monitor.png?raw=true)
...
<a id="shutting-down-an-instance-and-cleaning-up" class="anchor" aria-hidden="true" href="#shutting-down-an-instance-and-cleaning-up"></a> 
...
![](https://github.com/ScientistJake/getting_started_with_AWS/blob/master/img/shutdown.png?raw=true)

<a id="learn-more" class="anchor" aria-hidden="true" href="#learn-more"></a> 
